...
*/
    ...
    public:
        enum pedalType {
            kDamperPedal, kSoftpedal, kSostenutoPedal
        };
        ...
        virtual void newNote(long date, int chan, float pitch, int velocity, int duration, int fret, int string,
                             int string_mute) { newNote(date, chan, pitch, velocity, duration); }
...
*/
    ...
    protected:
        ...
        virtual void playNote(const noteextendedvisitor &note);
